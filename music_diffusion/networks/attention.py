...
class SelfAttention2d(nn.Module):
    def __init__(
        ...
        self.__query_conv = ChannelProjBlock(channels, emb_dim, 1)
        self.__key_conv = ChannelProjBlock(channels, key_dim, 1)
        self.__value_conv = ChannelProjBlock(channels, value_dim, 1)
